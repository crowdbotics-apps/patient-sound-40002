"""
Django settings for patient_sound_40002 project.
...
ROOT_URLCONF = 'patient_sound_40002.urls'
...
WSGI_APPLICATION = 'patient_sound_40002.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_sound_40002 API",
    "DESCRIPTION": "API documentation for patient_sound_40002 App",
    "VERSION": "v1",
}
